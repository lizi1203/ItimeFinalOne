...
public class ColorPickerView extends View {
    ...
    private static final float[] mPostitions = new float[]{0.0f, 0.143f, 0.286f, 0.429f, 0.571f, 0.714f, 0.857f, 1.0f};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setShader(s);
        RectF rectF = new RectF(paddingWidth, (height >> 1) - 6 * density, width - paddingWidth, (height >> 1) + 6 * density);
    ...
    private int getColorByPosition(float position) {
        ...
        switch (index) {
            ...
            case 5://0xFFFF00FF,0xFFFFFFFF
                return Color.argb(0xFF, 0xFF, getNumberByPersent(percent, 0x00, 0xFF), 0xFF);
            case 6://0xFFFFFFFF, 0xFF000000
                int number = getNumberByPersent(percent, 0xFF, 0x00);
